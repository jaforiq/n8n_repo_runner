...
waitForElement(`#expressionBtn${id}`, 1000).then(() => {
  ...
  const optionLabels = {
    ...
    "max-iterations": "Sender",
    "return-intermediate-steps": "Include Spam and Trash",
    "automatically-passthrough-binary-images": "Include Drafts",
  }
...
function getOptionContent(optionType, id) {
  ...
  switch (optionType) {
    case "system-message":
      return `
        <div id="fixedSection${id}" class="relative">
          <input type="number" class="w-full bg-[#000814] text-white px-2 py-2 xs:px-2 xs:py-2 rounded-md border border-gray-600 focus:outline-none focus:ring-1 focus:ring-amber-500 focus:ring-inset text-xs xs:text-sm" placeholder="Enter search value..." />
        </div>
    ...
    case "max-iterations":
      return `
        <div id="fixedSection${id}" class="relative">
          <input type="number" class="w-full bg-[#000814] text-white px-2 py-2 xs:px-2 xs:py-2 rounded-md border border-gray-600 focus:outline-none focus:ring-1 focus:ring-amber-500 focus:ring-inset text-xs xs:text-sm" />
        </div>
        <div id="expressionSection${id}" class="relative z-10 hidden">
          <div class="relative">
            <div
